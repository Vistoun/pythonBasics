...
PI = 3.14 #spravně
city = "Opava" #spravně 
hilda@sspu-opava.cz = 'Hilda Dokonalá' #nesmí obsahovat symbol @ 
#hilda(zavinac)sspu-opava.cz

password2 = 'TajneHeslo' #spravně 
007agent = 'James Bond' #nemuže začínat numerickým znakem 
#agent007 = 'James Bond'
